  ...
  return (
    <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="space-y-2 text-center lg:text-left">
        <h2 className="text-4xl font-bold text-text-primary tracking-tight">Create Account</h2>
        <p className="text-text-secondary text-lg">Join Monivo and start your financial journey.</p>
      </div>
      ...
      <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="text-xs text-text-secondary px-1 py-1">
          ...
          <button type="button" className="text-primary hover:underline cursor-pointer">Terms of Service</button> and{" "}
